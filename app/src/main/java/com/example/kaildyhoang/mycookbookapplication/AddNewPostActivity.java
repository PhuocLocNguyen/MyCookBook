...
public class AddNewPostActivity extends AppCompatActivity{
    ...
    private void doUpdatePost(String directionKey, String uid){
        ...
        Toast.makeText(getApplicationContext(),"Edit post successed",Toast.LENGTH_SHORT).show();
    ...
    private void doCreatePost(String uid){
        ...
        startActivity(new Intent(getApplicationContext(),MainActivity_View.class));
        Toast.makeText(getApplicationContext(),"Create post successed",Toast.LENGTH_SHORT).show();
    }
    @Override
