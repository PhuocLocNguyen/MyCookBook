...
public class ChatActivity extends AppCompatActivity {
    ...
    private LinearLayoutManager mLayoutMng;
    ...
    private void initialiseScreen(){
        ...
        mLayoutMng = new LinearLayoutManager(ChatActivity.this);
                ...
                mDatabaseRef.child("chat/"+type))
        {
            ...
            protected void populateViewHolder(ChatViewHolder viewHolder, Chat model, int position) {
                ...
                if(model.getSender().equals(uid)){
                    ...
                    viewHolder._llMsg.setPadding(20,20,20,20);
    ...
    private void doCreateMsgNotification(String uid, String notiMsg, String notiId, String avatar,String name, int isReaded){
        long _dateNow = TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis());
        NotificationObj notificationObj = new NotificationObj(notiMsg,notiId, avatar, name,isReaded,_dateNow);
        mDatabaseRef.child("users/"+uid+"/notifications/chat_notifications").push().setValue(notificationObj);
    }
                ...
                if(dataSnapshot.hasChild(room_type_1)){
                    mDatabaseRef.child("users/"+uid).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            doCreateMsgNotification(keyFriend,messenger,uid,avatar,name,0);
                            _edtChat.setText("");
                        }
