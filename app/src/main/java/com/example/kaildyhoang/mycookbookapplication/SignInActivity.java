...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void isExist(final FirebaseUser user){
        mDatabaseRef.child("users").getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void updateUI() {
        ...
        if (userfb != null ) {
            ...
            User user = new User(
                    ...
                    userfb.getEmail(),
                    String.valueOf(userfb.getPhotoUrl()),
                    _dateNow
            );
